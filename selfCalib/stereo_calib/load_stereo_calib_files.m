...
calib_file_name_left = input('Name of the left camera calibration file ([]=Calib_Results_L.mat): ','s');
...
calib_file_name_right = input('Name of the right camera calibration file ([]=Calib_Results_R.mat): ','s');
