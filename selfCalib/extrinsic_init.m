function [omckk,Tckk,Rckk] = extrinsic_init(x_kk,X_kk,fc,cc,kc,alpha_c),


%根据给定的内部参数和3D空间坐标X_kk在图像平面的投影x_kk计算外部参数
%
...
xn = normalize_pixel(x_kk,fc,cc,kc,alpha_c);   % 根据给定的参数和相机坐标系下坐标计算归一化的像素坐标
