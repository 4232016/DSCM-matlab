...
[calib_file_name_left,calib_file_path_left] = uigetfile({'.mat'},'选择左相机标定数据Calib_Results_L');

if isempty(calib_file_name_left),
    calib_file_name_left = 'Calib_Results_L.mat';
end;


[calib_file_name_right,calib_file_path_right] = uigetfile({'.mat'},'选择右相机标定数据Calib_Results_R');

if isempty(calib_file_name_right),
    calib_file_name_right = 'Calib_Results_R.mat';
end;
